...
input_path = root_dir / "data" / "test" / "test_cleaned.csv" #add your dataset path
output_path = root_dir / "data" / "test" / "test_sentiment.csv" #add desired path for your cleaned dataset to be saved
